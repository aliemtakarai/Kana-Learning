  ...
  <div class="hiragana-page">
    ...
    <section class="hero-section">
      <div class="container">
        <div class="hero-content">
          ...
          <p class="hero-description">{{ t('hiragana.description') }}</p>
    ...
    <section class="info-section">
      <div class="container">
        <div class="info-grid">
          <div class="info-card">
            <div class="info-icon">あ</div>
            <h3>{{ t('home.charts.basic') }}</h3>
            <p>{{ t('hiragana.basicInfo') }}</p>
          </div>
          <div class="info-card">
            <div class="info-icon">が</div>
            <h3>{{ t('home.charts.dakuten') }}</h3>
            <p>{{ t('hiragana.dakutenInfo') }}</p>
          </div>
          <div class="info-card">
        ...
        <div class="kana-grid-container">
          <div class="kana-grid">
            <div 
              ...
              :key="`hiragana-${activeCategory}-${index}`"
              class="kana-card"
